...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "resurrection-data.json" ],
					"patching_rect" : [ 45.0, 225.0, 133.0, 20.0 ],
					"text" : "t resurrection-data.json"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "int", "resurrection-data.json" ],
					"patching_rect" : [ 30.0, 120.0, 143.0, 20.0 ],
					"text" : "t 1 resurrection-data.json"
				}
...
, 			{
				"box" : 				{
					"args" : [ "rb._dict", "wrapper around cue dictionary" ],
					"id" : "obj-7",
					"maxclass" : "bpatcher",
...
,
					"text" : "dict rb.cues resurrection-data.json"
				}
