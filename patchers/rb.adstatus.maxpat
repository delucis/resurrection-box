...
,
					"patching_rect" : [ 105.0, 135.0, 95.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 15.0, 165.0, 195.0, 30.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "rb.adstatus", "big button to report/switch audio status" ],
					"id" : "obj-1",
					"maxclass" : "bpatcher",
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 213.0, 224.5, 213.0, 224.5, 71.0, 24.5, 71.0 ],
					"source" : [ "obj-102", 0 ]
				}
